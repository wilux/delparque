 ...
 * @access public
 */
final class creamery_lite_Example_1_Customize {
	...
	public function creamery_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'creamery_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new creamery_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
...
creamery_lite_Example_1_Customize::creamery_lite_get_instance();